 ...
 */
export async function getOrCreateChip(
  uid: string,
): Promise<Tables<"chips"> | null> {
  const supabase = getServerSupabase()
 ...
 */
export async function getChipByUid(
  uid: string,
): Promise<Tables<"chips"> | null> {
  const supabase = getServerSupabase()
 ...
 */
export async function hasChipClaimedReward(
  chipId: number,
...
export async function startRewardPeriod(
  createdBy: string,
): Promise<Tables<"reward_periods"> | null> {
  const supabase = getServerSupabase()
